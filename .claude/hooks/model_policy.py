...
POLICY = (
    ...
    "ACT ON IT: routing only saves the cap if acted on — delegate trivial/normal work to cheaper "
    "subagents (Haiku/Sonnet), reserve the Opus session for genuinely hard tasks.\n"
